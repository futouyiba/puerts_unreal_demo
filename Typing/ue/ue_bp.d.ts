...
// __TYPE_DECL_END
// __TYPE_DECL_START: E5E0BBF1CA4814416D7F89ACE7A35B8B
    namespace NodeToCode.UI.Theming.N2C_PDA_ThemeBase {
        class N2C_PDA_ThemeBase_C extends UE.PrimaryDataAsset {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            Background: UE.LinearColor;
            Panel: UE.LinearColor;
            Secondary: UE.LinearColor;
            ["Input Background"]: UE.LinearColor;
            Foreground: UE.LinearColor;
            Recessed: UE.LinearColor;
            Primary: UE.LinearColor;
            Error: UE.LinearColor;
            Success: UE.LinearColor;
            ["Input Outline"]: UE.LinearColor;
            ["Hover 1"]: UE.LinearColor;
            ["Hover 2"]: UE.LinearColor;
            ["Dropdown Outline"]: UE.LinearColor;
            GetThemeColor(ColorVariable: UE.NodeToCode.UI.Theming.N2C_E_Theme_Variables.N2C_E_Theme_Variables, Color: $Ref<UE.LinearColor>) : void;
            UpdateThemeFromCodeEditorTheme(NewColors: UE.N2CCodeEditorColors) : void;
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): N2C_PDA_ThemeBase_C;
            static Load(InName: string): N2C_PDA_ThemeBase_C;
        
            __tid_N2C_PDA_ThemeBase_C_0__: boolean;
        }
...
// __TYPE_DECL_END
// __TYPE_DECL_START: B7D1FE29BF47DDE8E55071989F553715
    namespace NodeToCode.UI.Theming.N2C_E_Theme_Variables {
        enum N2C_E_Theme_Variables { Background, Panel, Secondary, "Input Background", Foreground, Recessed, Primary, Error, Success, "Input Outline", "Hover 1", "Hover 2", "Dropdown Outline", N2C_E_Theme_MAX, __typeKeyDoNoAccess}
    }

// __TYPE_DECL_END
// __TYPE_DECL_START: 8CF7A407EF41F9CDF1511D96C9D28596
    namespace NodeToCode.UI.Components.Base.N2C_EUW_Button {
        class N2C_EUW_Button_C extends UE.NodeToCode.UI.Components.Base.N2C_EUW_Base.N2C_EUW_Base_C {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            UberGraphFrame: UE.PointerToUberGraphFrame;
            Button_0: UE.Button;
            Image_Icon: UE.Image;
            ScaleBox_Text: UE.ScaleBox;
            Text_Block: UE.TextBlock;
            NormalColor: UE.NodeToCode.UI.Theming.N2C_E_Theme_Variables.N2C_E_Theme_Variables;
            NormalColor_Outline: UE.NodeToCode.UI.Theming.N2C_E_Theme_Variables.N2C_E_Theme_Variables;
            CornerRadii: UE.Vector4;
            HoveredColor: UE.NodeToCode.UI.Theming.N2C_E_Theme_Variables.N2C_E_Theme_Variables;
            HoveredColor_Outline: UE.NodeToCode.UI.Theming.N2C_E_Theme_Variables.N2C_E_Theme_Variables;
            PressedColor: UE.NodeToCode.UI.Theming.N2C_E_Theme_Variables.N2C_E_Theme_Variables;
            PressedColor_Outline: UE.NodeToCode.UI.Theming.N2C_E_Theme_Variables.N2C_E_Theme_Variables;
            Dimensions: UE.Vector2D;
            UseIcon: boolean;
            Icon: UE.Texture2D;
            IconSize: UE.Vector2D;
            IconHorizontalAlignment: UE.EHorizontalAlignment;
            IconPadding: UE.Margin;
            UseText: boolean;
            Text: string;
            TextHorizontalAlignment: UE.EHorizontalAlignment;
            TextJustification: UE.ETextJustify;
            TextTypface: string;
            TextSize: number;
            TextColor: UE.NodeToCode.UI.Theming.N2C_E_Theme_Variables.N2C_E_Theme_Variables;
            TextPadding: UE.Margin;
            OnButtonClicked: $MulticastDelegate<() => void>;
            BndEvt__N2C_EUW_Button_Button_0_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature() : void;
            /*
             ...
             */
            Construct() : void;
            ExecuteUbergraph_N2C_EUW_Button(EntryPoint: number) : void;
            GetIconOverlaySlot(AsOverlaySlot: $Ref<UE.OverlaySlot>) : void;
            GetStateStyle(BaseColor: UE.NodeToCode.UI.Theming.N2C_E_Theme_Variables.N2C_E_Theme_Variables, OutlineColor: UE.NodeToCode.UI.Theming.N2C_E_Theme_Variables.N2C_E_Theme_Variables, SlateBrush: $Ref<UE.SlateBrush>) : void;
            GetTextScaleBoxSlot(AsScaleBoxSlot: $Ref<UE.ScaleBoxSlot>) : void;
            Initialize() : void;
            ...
            UpdateIcon(UseIcon: boolean) : void;
            UpdateStyle(NormalColor: UE.NodeToCode.UI.Theming.N2C_E_Theme_Variables.N2C_E_Theme_Variables, NormalOutlineColor: UE.NodeToCode.UI.Theming.N2C_E_Theme_Variables.N2C_E_Theme_Variables, HoveredColor: UE.NodeToCode.UI.Theming.N2C_E_Theme_Variables.N2C_E_Theme_Variables, HoveredOutlineColor: UE.NodeToCode.UI.Theming.N2C_E_Theme_Variables.N2C_E_Theme_Variables, PressedColor: UE.NodeToCode.UI.Theming.N2C_E_Theme_Variables.N2C_E_Theme_Variables, PressedOutlineColor: UE.NodeToCode.UI.Theming.N2C_E_Theme_Variables.N2C_E_Theme_Variables) : void;
            UpdateText(NewText: string) : void;
            UpdateTextProperties(UseText: boolean, Text: string, Color: UE.NodeToCode.UI.Theming.N2C_E_Theme_Variables.N2C_E_Theme_Variables, HorizontalAlignment: UE.EHorizontalAlignment, Justification: UE.ETextJustify, Typeface: string, Size: number) : void;
            UpdateThemeColors(IsDefaultTheme: boolean, NewColors: UE.N2CCodeEditorColors) : void;
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): N2C_EUW_Button_C;
            static Load(InName: string): N2C_EUW_Button_C;
        
            __tid_N2C_EUW_Button_C_0__: boolean;
        }
...
// __TYPE_DECL_END
// __TYPE_DECL_START: 4A5787D4FA45BA996EC9F082D088D65D
    namespace NodeToCode.UI.Components.Base.N2C_EUW_Border {
        class N2C_EUW_Border_C extends UE.NodeToCode.UI.Components.Base.N2C_EUW_Base.N2C_EUW_Base_C {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            UberGraphFrame: UE.PointerToUberGraphFrame;
            Border_0: UE.Border;
            PrimaryColor: UE.NodeToCode.UI.Theming.N2C_E_Theme_Variables.N2C_E_Theme_Variables;
            OutlineColor: UE.NodeToCode.UI.Theming.N2C_E_Theme_Variables.N2C_E_Theme_Variables;
            CornerRadii: UE.Vector4;
            Dimensions: UE.Vector2D;
            ExecuteUbergraph_N2C_EUW_Border(EntryPoint: number) : void;
            Initialize() : void;
            /*
             *Called by both the game and the editor.  Allows users to run initial setup for their widgets to better preview
             *the setup in the designer and since generally that same setup code is required at runtime, it's called there
            ...
            UpdateThemeColors(IsDefaultTheme: boolean, NewColors: UE.N2CCodeEditorColors) : void;
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): N2C_EUW_Border_C;
            static Load(InName: string): N2C_EUW_Border_C;
        
            __tid_N2C_EUW_Border_C_0__: boolean;
        }
        
    }

// __TYPE_DECL_END
// __TYPE_DECL_START: 25F78AB0E7472AAB6E5970A98E8EE828
    namespace NodeToCode.UI.Components.Base.N2C_EUW_Base {
        class N2C_EUW_Base_C extends UE.EditorUtilityWidget {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            UberGraphFrame: UE.PointerToUberGraphFrame;
            Theme: UE.NodeToCode.UI.Theming.N2C_PDA_ThemeBase.N2C_PDA_ThemeBase_C;
            UsingDefaultTheme: boolean;
            CurrentThemeColors: UE.N2CCodeEditorColors;
            ExecuteUbergraph_N2C_EUW_Base(EntryPoint: number) : void;
            GetThemeColor(ColorVariable: UE.NodeToCode.UI.Theming.N2C_E_Theme_Variables.N2C_E_Theme_Variables, Color: $Ref<UE.LinearColor>) : void;
            /*
             *Called by both the game and the editor.  Allows users to run initial setup for their widgets to better preview
             *the setup in the designer and since generally that same setup code is required at runtime, it's called there
            ...
            UpdateThemeColors(IsDefaultTheme: boolean, NewColors: UE.N2CCodeEditorColors) : void;
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): N2C_EUW_Base_C;
            static Load(InName: string): N2C_EUW_Base_C;
        
            __tid_N2C_EUW_Base_C_0__: boolean;
        }
        
    }

// __TYPE_DECL_END
// __TYPE_DECL_START: 8B9115D2A94C58ED3E0C23AD0D98703F
    namespace NodeToCode.UI.Components.N2C_EUW_TranslationTab {
        class N2C_EUW_TranslationTab_C extends UE.NodeToCode.UI.Components.Base.N2C_EUW_Base.N2C_EUW_Base_C {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            UberGraphFrame: UE.PointerToUberGraphFrame;
            Button_Tab: UE.NodeToCode.UI.Components.Base.N2C_EUW_Button.N2C_EUW_Button_C;
            OnTabClicked: $MulticastDelegate<(Code: string) => void>;
            AssociatedSourceCode: string;
            AssignAssociatedSourceCode(GraphName: string, SourceCode: string, OpenOnLoad: boolean, TabIsRequired: boolean) : void;
            BndEvt__N2C_EUW_TranslationTab_N2C_EUW_Button_K2Node_ComponentBoundEvent_0_OnButtonClicked__DelegateSignature() : void;
            ExecuteUbergraph_N2C_EUW_TranslationTab(EntryPoint: number) : void;
            GetTranslatedGraph(Code: $Ref<string>) : void;
            OnTabClicked__DelegateSignature(Code: string) : void;
            SetToggledState(Toggled: boolean) : void;
            UpdateThemeColors(IsDefaultTheme: boolean, NewColors: UE.N2CCodeEditorColors) : void;
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): N2C_EUW_TranslationTab_C;
            static Load(InName: string): N2C_EUW_TranslationTab_C;
        
            __tid_N2C_EUW_TranslationTab_C_0__: boolean;
        }
        
    }

// __TYPE_DECL_END
// __TYPE_DECL_START: 8788924E443CA0CFD4C7FF9265E3D1F8
    namespace NodeToCode.UI.Components.N2C_EUW_TranslatedGraphsBrowser {
        class N2C_EUW_TranslatedGraphsBrowser_C extends UE.NodeToCode.UI.Components.Base.N2C_EUW_Base.N2C_EUW_Base_C {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            UberGraphFrame: UE.PointerToUberGraphFrame;
            Border_Background: UE.NodeToCode.UI.Components.Base.N2C_EUW_Border.N2C_EUW_Border_C;
            Border_Divider: UE.NodeToCode.UI.Components.Base.N2C_EUW_Border.N2C_EUW_Border_C;
            Button_OpenTranslationFolder: UE.NodeToCode.UI.Components.Base.N2C_EUW_Button.N2C_EUW_Button_C;
            ScrollBox_TranslatedGraphs: UE.EditorUtilityScrollBox;
            Text_Title: UE.TextBlock;
            Text_TranslationCost: UE.TextBlock;
            VerticalBox_TranslatedGraphs: UE.VerticalBox;
            OnGraphTranslationClicked: $MulticastDelegate<(GraphTranslation: UE.N2CGraphTranslation) => void>;
            BndEvt__N2C_EUW_TranslatedGraphsBrowser_Button_OpenTranslationFolder_K2Node_ComponentBoundEvent_0_OnButtonClicked__DelegateSignature() : void;
            ClearTranslations() : void;
            ExecuteUbergraph_N2C_EUW_TranslatedGraphsBrowser(EntryPoint: number) : void;
            GetTranslationResponseCost(TranslationResponse: UE.N2CTranslationResponse, Cost: $Ref<number>) : void;
            GetTranslationResponseCostText(TranslationResponse: UE.N2CTranslationResponse, Text: $Ref<string>) : void;
            GraphTranslationClicked(GraphTranslation: UE.N2CGraphTranslation, ClickedTranslatedGraph: $Nullable<UE.NodeToCode.UI.Components.N2C_EUW_TranslatedGraph.N2C_EUW_TranslatedGraph_C>) : void;
            InitializeTextColors() : void;
            LoadBlueprintTranslation(TranslationResponse: UE.N2CTranslationResponse) : void;
            OnGraphTranslationClicked__DelegateSignature(GraphTranslation: UE.N2CGraphTranslation) : void;
            /*
             *Called by both the game and the editor.  Allows users to run initial setup for their widgets to better preview
             *the setup in the designer and since generally that same setup code is required at runtime, it's called there
             *as well.
            ...
            UpdateThemeColors(IsDefaultTheme: boolean, NewColors: UE.N2CCodeEditorColors) : void;
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): N2C_EUW_TranslatedGraphsBrowser_C;
            static Load(InName: string): N2C_EUW_TranslatedGraphsBrowser_C;
        
            __tid_N2C_EUW_TranslatedGraphsBrowser_C_0__: boolean;
        }
        
    }

// __TYPE_DECL_END
// __TYPE_DECL_START: B96668D9E2479516B4F48C9A0D535DC6
    namespace NodeToCode.UI.Components.N2C_EUW_TranslatedGraph {
        class N2C_EUW_TranslatedGraph_C extends UE.NodeToCode.UI.Components.Base.N2C_EUW_Base.N2C_EUW_Base_C {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            UberGraphFrame: UE.PointerToUberGraphFrame;
            Button_Tab: UE.NodeToCode.UI.Components.Base.N2C_EUW_Button.N2C_EUW_Button_C;
            OnButtonClicked: $MulticastDelegate<(GraphTranslation: UE.N2CGraphTranslation, ClickedTranslatedGraph: $Nullable<UE.NodeToCode.UI.Components.N2C_EUW_TranslatedGraph.N2C_EUW_TranslatedGraph_C>) => void>;
            AssociatedGraphTranslation: UE.N2CGraphTranslation;
            ToggledOnConstruct: boolean;
            IsToggled: boolean;
            AssignTranslatedGraph(GraphTranslation: UE.N2CGraphTranslation, OpenOnLoad: boolean) : void;
            BndEvt__N2C_EUW_TranslationTab_N2C_EUW_Button_K2Node_ComponentBoundEvent_0_OnButtonClicked__DelegateSignature() : void;
            /*
             *Called after the underlying slate widget is constructed.  Depending on how the slate object is used
             *this event may be called multiple times due to adding and removing from the hierarchy.
             ...
             */
            Construct() : void;
            ExecuteUbergraph_N2C_EUW_TranslatedGraph(EntryPoint: number) : void;
            GetTranslatedGraph(TranslatedGraph: $Ref<UE.N2CGraphTranslation>) : void;
            OnButtonClicked__DelegateSignature(GraphTranslation: UE.N2CGraphTranslation, ClickedTranslatedGraph: $Nullable<UE.NodeToCode.UI.Components.N2C_EUW_TranslatedGraph.N2C_EUW_TranslatedGraph_C>) : void;
            /*
             *Called by both the game and the editor.  Allows users to run initial setup for their widgets to better preview
             *the setup in the designer and since generally that same setup code is required at runtime, it's called there
             *as well.
            ...
            UpdateThemeColors(IsDefaultTheme: boolean, NewColors: UE.N2CCodeEditorColors) : void;
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): N2C_EUW_TranslatedGraph_C;
            static Load(InName: string): N2C_EUW_TranslatedGraph_C;
        
            __tid_N2C_EUW_TranslatedGraph_C_0__: boolean;
        }
        
    }

// __TYPE_DECL_END
// __TYPE_DECL_START: 1B0753BE41DF236D7AB03B91F25EEE7B
    namespace NodeToCode.UI.Components.N2C_EUW_Styling {
        class N2C_EUW_Styling_C extends UE.NodeToCode.UI.Components.Base.N2C_EUW_Base.N2C_EUW_Base_C {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            UberGraphFrame: UE.PointerToUberGraphFrame;
            Border_Background: UE.NodeToCode.UI.Components.Base.N2C_EUW_Border.N2C_EUW_Border_C;
            Border_Divider: UE.NodeToCode.UI.Components.Base.N2C_EUW_Border.N2C_EUW_Border_C;
            ComboBox_Theme: UE.EditorUtilityComboBoxString;
            SpinBox_FontSize: UE.EditorUtilitySpinBox;
            Text_FontSize: UE.TextBlock;
            Text_Theme: UE.TextBlock;
            Text_Title: UE.TextBlock;
            CodeEditor: UE.NodeToCode.UI.Components.N2C_EUW_CodeEditor.N2C_EUW_CodeEditor_C;
            OnThemeChanged: $MulticastDelegate<(NewTheme: string) => void>;
            OnCodeEditorRefRequested: $MulticastDelegate<() => void>;
            BndEvt__N2C_EUW_Styling_SpinBox_FontSize_K2Node_ComponentBoundEvent_1_OnSpinBoxValueChangedEvent__DelegateSignature(InValue: number) : void;
            BndEvt__N2C_EUW_Syling_ComboBox_Theme_K2Node_ComponentBoundEvent_0_OnSelectionChangedEvent__DelegateSignature(SelectedItem: string, SelectionType: UE.ESelectInfo) : void;
            /*
             ...
             */
            Destruct() : void;
            ExecuteUbergraph_N2C_EUW_Styling(EntryPoint: number) : void;
            GetComboBoxStateColors(FillColor: UE.NodeToCode.UI.Theming.N2C_E_Theme_Variables.N2C_E_Theme_Variables, OutlineColor: UE.NodeToCode.UI.Theming.N2C_E_Theme_Variables.N2C_E_Theme_Variables, SlateBrush: $Ref<UE.SlateBrush>) : void;
            Initialize() : void;
            InitializeComboBoxStyle() : void;
            InitializeSpinBoxStyle() : void;
            InitializeTextColors() : void;
            OnCodeEditorRefRequested__DelegateSignature() : void;
            OnThemeChanged__DelegateSignature(NewTheme: string) : void;
            /*
             *Called by both the game and the editor.  Allows users to run initial setup for their widgets to better preview
             *the setup in the designer and since generally that same setup code is required at runtime, it's called there
             *as well.
            ...
            UpdateThemeColors(IsDefaultTheme: boolean, NewColors: UE.N2CCodeEditorColors) : void;
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): N2C_EUW_Styling_C;
            static Load(InName: string): N2C_EUW_Styling_C;
        
            __tid_N2C_EUW_Styling_C_0__: boolean;
        }
        
    }

// __TYPE_DECL_END
// __TYPE_DECL_START: CE1FD3ED409D7B69F917AB90F369A8AC
    namespace NodeToCode.UI.Components.N2C_EUW_StatusOverlay {
        class N2C_EUW_StatusOverlay_C extends UE.NodeToCode.UI.Components.Base.N2C_EUW_Base.N2C_EUW_Base_C {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            UberGraphFrame: UE.PointerToUberGraphFrame;
            AnimClose: UE.WidgetAnimation;
            AnimOpen: UE.WidgetAnimation;
            Border_Background: UE.NodeToCode.UI.Components.Base.N2C_EUW_Border.N2C_EUW_Border_C;
            Button_Dismiss: UE.NodeToCode.UI.Components.Base.N2C_EUW_Button.N2C_EUW_Button_C;
            Text_Primary: UE.TextBlock;
            Text_Secondary: UE.TextBlock;
            Throbber_Processing: UE.EditorUtilityThrobber;
            PreviousStatus: UE.EN2CSystemStatus;
            IsOpen: boolean;
            BndEvt__N2C_EUW_StatusOverlay_Button_Dismiss_K2Node_ComponentBoundEvent_0_OnButtonClicked__DelegateSignature() : void;
            Close() : void;
            ExecuteUbergraph_N2C_EUW_StatusOverlay(EntryPoint: number) : void;
            InitializeTextStyle() : void;
            InitializeThrobberStyle() : void;
            Open() : void;
            /*
             *Called by both the game and the editor.  Allows users to run initial setup for their widgets to better preview
             *the setup in the designer and since generally that same setup code is required at runtime, it's called there
             ...
             */
            PreConstruct(IsDesignTime: boolean) : void;
            UpdateStatus(NewStatus: UE.EN2CSystemStatus) : void;
            UpdateText(Primary: string, Secondary: string) : void;
            UpdateThemeColors(IsDefaultTheme: boolean, NewColors: UE.N2CCodeEditorColors) : void;
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): N2C_EUW_StatusOverlay_C;
            static Load(InName: string): N2C_EUW_StatusOverlay_C;
        
            __tid_N2C_EUW_StatusOverlay_C_0__: boolean;
        }
        
    }

// __TYPE_DECL_END
// __TYPE_DECL_START: 1B31579940EAE386847CEE8271678C2B
    namespace NodeToCode.UI.Components.N2C_EUW_NavBar {
        class N2C_EUW_NavBar_C extends UE.NodeToCode.UI.Components.Base.N2C_EUW_Base.N2C_EUW_Base_C {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            UberGraphFrame: UE.PointerToUberGraphFrame;
            Border_BG: UE.NodeToCode.UI.Components.Base.N2C_EUW_Border.N2C_EUW_Border_C;
            Border_Divider_Left: UE.NodeToCode.UI.Components.Base.N2C_EUW_Border.N2C_EUW_Border_C;
            Border_Divider_Right: UE.NodeToCode.UI.Components.Base.N2C_EUW_Border.N2C_EUW_Border_C;
            Button_Styling: UE.NodeToCode.UI.Components.Base.N2C_EUW_Button.N2C_EUW_Button_C;
            Button_TranslationNotes: UE.NodeToCode.UI.Components.N2C_EUW_Button_TranslationNotes.N2C_EUW_Button_TranslationNotes_C;
            Button_Translations: UE.NodeToCode.UI.Components.Base.N2C_EUW_Button.N2C_EUW_Button_C;
            Button_TranslationTab_Decl: UE.NodeToCode.UI.Components.N2C_EUW_TranslationTab.N2C_EUW_TranslationTab_C;
            Button_TranslationTab_Impl: UE.NodeToCode.UI.Components.N2C_EUW_TranslationTab.N2C_EUW_TranslationTab_C;
            Indicator_Translations: UE.NodeToCode.UI.Components.Base.N2C_EUW_Border.N2C_EUW_Border_C;
            OnGraphTranslationTabClicked: $MulticastDelegate<(Code: string, IsDeclaration: boolean) => void>;
            OnStylingClicked: $MulticastDelegate<() => void>;
            OnTranslationsClicked: $MulticastDelegate<() => void>;
            OnTranslationNotesClicked: $MulticastDelegate<(TranslationNotes: string) => void>;
            OnAssignedEmptyNotes: $MulticastDelegate<() => void>;
            OnTranslationNotesUpdated: $MulticastDelegate<(NewNotes: string) => void>;
            BndEvt__N2C_EUW_NavBar_Button_Styling_K2Node_ComponentBoundEvent_3_OnButtonClicked__DelegateSignature() : void;
            BndEvt__N2C_EUW_NavBar_Button_TranslationNotes_K2Node_ComponentBoundEvent_2_OnButtonClicked__DelegateSignature(ImplementationNotes: string) : void;
            BndEvt__N2C_EUW_NavBar_Button_TranslationNotes_K2Node_ComponentBoundEvent_5_OnAssignedEmptyNotes__DelegateSignature() : void;
            BndEvt__N2C_EUW_NavBar_Button_TranslationNotes_K2Node_ComponentBoundEvent_6_OnNotesUpdated__DelegateSignature(NewNotes: string) : void;
            BndEvt__N2C_EUW_NavBar_Button_Translations_K2Node_ComponentBoundEvent_4_OnButtonClicked__DelegateSignature() : void;
            BndEvt__N2C_EUW_NavBar_Button_TranslationTab_Decl_K2Node_ComponentBoundEvent_1_OnTabClicked__DelegateSignature(Code: string) : void;
            BndEvt__N2C_EUW_NavBar_Button_TranslationTab_Impl_K2Node_ComponentBoundEvent_0_OnTabClicked__DelegateSignature(Code: string) : void;
            ExecuteUbergraph_N2C_EUW_NavBar(EntryPoint: number) : void;
            GetTabFileName(GraphName: string, IsCppHeader: boolean) : string;
            HideTranslationTabs() : void;
            OnAssignedEmptyNotes__DelegateSignature() : void;
            OnGraphTranslationTabClicked__DelegateSignature(Code: string, IsDeclaration: boolean) : void;
            /*
             ...
             */
            OnInitialized() : void;
            OnStylingClicked__DelegateSignature() : void;
            OnTranslationNotesClicked__DelegateSignature(TranslationNotes: string) : void;
            OnTranslationNotesUpdated__DelegateSignature(NewNotes: string) : void;
            OnTranslationsClicked__DelegateSignature() : void;
            OpenGraphTranslation(TranslatedGraph: UE.N2CGraphTranslation) : void;
            OverrideNotesButtonState(IsToggled: boolean) : void;
            OverrideStylingMenuButtonState(IsToggled: boolean) : void;
            OverrideTranslationsBrowserState(IsToggled: boolean) : void;
            /*
             *Called by both the game and the editor.  Allows users to run initial setup for their widgets to better preview
             *the setup in the designer and since generally that same setup code is required at runtime, it's called there
             *as well.
             ...
             */
            PreConstruct(IsDesignTime: boolean) : void;
            SetTranslationNotesIndicatorState(Visible: boolean) : void;
            SetTranslationsIndicatorState(Visible: boolean) : void;
            UpdateThemeColors(IsDefaultTheme: boolean, NewColors: UE.N2CCodeEditorColors) : void;
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): N2C_EUW_NavBar_C;
            static Load(InName: string): N2C_EUW_NavBar_C;
        
            __tid_N2C_EUW_NavBar_C_0__: boolean;
        }
        
    }

// __TYPE_DECL_END
// __TYPE_DECL_START: A5B7F3A4F149A0D0443667AC341EF648
    namespace NodeToCode.UI.Components.N2C_EUW_ImplementationNotes {
        class N2C_EUW_ImplementationNotes_C extends UE.NodeToCode.UI.Components.Base.N2C_EUW_Base.N2C_EUW_Base_C {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            UberGraphFrame: UE.PointerToUberGraphFrame;
            Border_Background: UE.NodeToCode.UI.Components.Base.N2C_EUW_Border.N2C_EUW_Border_C;
            Border_HeaderBackground: UE.NodeToCode.UI.Components.Base.N2C_EUW_Border.N2C_EUW_Border_C;
            Button_Close: UE.NodeToCode.UI.Components.Base.N2C_EUW_Button.N2C_EUW_Button_C;
            Button_Copy: UE.NodeToCode.UI.Components.Base.N2C_EUW_Button.N2C_EUW_Button_C;
            Image_Icon: UE.Image;
            Text_Title: UE.TextBlock;
            TextBox_Notes: UE.EditorUtilityMultiLineEditableTextBox;
            OnNotesWindowCloseButtonClicked: $MulticastDelegate<() => void>;
            OnNotesCopiedToClipboard: $MulticastDelegate<(Text: string) => void>;
            BndEvt__N2C_EUW_ImplementationNotes_Button_Close_K2Node_ComponentBoundEvent_1_OnButtonClicked__DelegateSignature() : void;
            BndEvt__N2C_EUW_ImplementationNotes_Button_Copy_K2Node_ComponentBoundEvent_0_OnButtonClicked__DelegateSignature() : void;
            ExecuteUbergraph_N2C_EUW_ImplementationNotes(EntryPoint: number) : void;
            InitializeTextStyles() : void;
            OnNotesCopiedToClipboard__DelegateSignature(Text: string) : void;
            OnNotesWindowCloseButtonClicked__DelegateSignature() : void;
            /*
             *Called by both the game and the editor.  Allows users to run initial setup for their widgets to better preview
             *the setup in the designer and since generally that same setup code is required at runtime, it's called there
             *as well.
             ...
             */
            PreConstruct(IsDesignTime: boolean) : void;
            UpdateText(InText: string) : void;
            UpdateThemeColors(IsDefaultTheme: boolean, NewColors: UE.N2CCodeEditorColors) : void;
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): N2C_EUW_ImplementationNotes_C;
            static Load(InName: string): N2C_EUW_ImplementationNotes_C;
        
            __tid_N2C_EUW_ImplementationNotes_C_0__: boolean;
        }
        
    }

// __TYPE_DECL_END
// __TYPE_DECL_START: 629C6C194BFE0D942D26879B080C5CC2
    namespace NodeToCode.UI.Components.N2C_EUW_CodeEditor {
        class N2C_EUW_CodeEditor_C extends UE.NodeToCode.UI.Components.Base.N2C_EUW_Base.N2C_EUW_Base_C {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            UberGraphFrame: UE.PointerToUberGraphFrame;
            Border_Background: UE.NodeToCode.UI.Components.Base.N2C_EUW_Border.N2C_EUW_Border_C;
            Button_Copy: UE.NodeToCode.UI.Components.Base.N2C_EUW_Button.N2C_EUW_Button_C;
            CodeEditor: UE.N2CCodeEditorWidget;
            OnCodeCopiedToClipboard: $MulticastDelegate<(Text: string) => void>;
            BndEvt__N2C_EUW_CodeEditor_Button_Copy_K2Node_ComponentBoundEvent_0_OnButtonClicked__DelegateSignature() : void;
            ExecuteUbergraph_N2C_EUW_CodeEditor(EntryPoint: number) : void;
            GetAvailableThemes(Themes: $Ref<TArray<string>>) : void;
            GetCurrentTheme(Theme: $Ref<string>) : void;
            GetThemeColorsFromName(Name: string, ThemeColors: $Ref<UE.N2CCodeEditorColors>) : void;
            InitializeText(UseDummyCode: boolean) : void;
            OnCodeCopiedToClipboard__DelegateSignature(Text: string) : void;
            /*
             *Called by both the game and the editor.  Allows users to run initial setup for their widgets to better preview
             *the setup in the designer and since generally that same setup code is required at runtime, it's called there
             *as well.
             ...
             */
            PreConstruct(IsDesignTime: boolean) : void;
            SetLanguage(NewLanguage: UE.EN2CCodeLanguage) : void;
            UpdateContent(StringContent: string) : void;
            UpdateTextSize(NewSize: number) : void;
            UpdateTheme(NewTheme: string) : void;
            UpdateThemeColors(IsDefaultTheme: boolean, NewColors: UE.N2CCodeEditorColors) : void;
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): N2C_EUW_CodeEditor_C;
            static Load(InName: string): N2C_EUW_CodeEditor_C;
        
            __tid_N2C_EUW_CodeEditor_C_0__: boolean;
        }
        
    }

// __TYPE_DECL_END
// __TYPE_DECL_START: 0F90C967164BDEDADFE5FBA2994856D9
    namespace NodeToCode.UI.Components.N2C_EUW_Button_TranslationNotes {
        class N2C_EUW_Button_TranslationNotes_C extends UE.NodeToCode.UI.Components.Base.N2C_EUW_Base.N2C_EUW_Base_C {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            UberGraphFrame: UE.PointerToUberGraphFrame;
            Button: UE.NodeToCode.UI.Components.Base.N2C_EUW_Button.N2C_EUW_Button_C;
            Indicator_Notes: UE.NodeToCode.UI.Components.Base.N2C_EUW_Border.N2C_EUW_Border_C;
            ImplementationNotes: string;
            OnButtonClicked: $MulticastDelegate<(ImplementationNotes: string) => void>;
            OnAssignedEmptyNotes: $MulticastDelegate<() => void>;
            OnNotesUpdated: $MulticastDelegate<(NewNotes: string) => void>;
            AssignImplementationNotes(Notes: string) : void;
            BndEvt__N2C_EUW_Button_TranslationNotes_Button_K2Node_ComponentBoundEvent_0_OnButtonClicked__DelegateSignature() : void;
            ExecuteUbergraph_N2C_EUW_Button_TranslationNotes(EntryPoint: number) : void;
            GetImplementationNotes(Notes: $Ref<string>) : void;
            OnAssignedEmptyNotes__DelegateSignature() : void;
            OnButtonClicked__DelegateSignature(ImplementationNotes: string) : void;
            OnNotesUpdated__DelegateSignature(NewNotes: string) : void;
            SetIndicatorState(Visible: boolean) : void;
            SetToggledState(Toggled: boolean) : void;
            UpdateThemeColors(IsDefaultTheme: boolean, NewColors: UE.N2CCodeEditorColors) : void;
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): N2C_EUW_Button_TranslationNotes_C;
            static Load(InName: string): N2C_EUW_Button_TranslationNotes_C;
        
            __tid_N2C_EUW_Button_TranslationNotes_C_0__: boolean;
        }
        
    }

// __TYPE_DECL_END
// __TYPE_DECL_START: 3C735E58485E10A368284BB8C169DCFE
    namespace NodeToCode.UI.NodeToCodeUI {
        class NodeToCodeUI_C extends UE.NodeToCode.UI.Components.Base.N2C_EUW_Base.N2C_EUW_Base_C {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            UberGraphFrame: UE.PointerToUberGraphFrame;
            AnimNotification: UE.WidgetAnimation;
            AnimCloseStyling: UE.WidgetAnimation;
            AnimOpenStyling: UE.WidgetAnimation;
            AnimCloseTranslations: UE.WidgetAnimation;
            AnimOpenTranslations: UE.WidgetAnimation;
            AnimCloseNotes: UE.WidgetAnimation;
            AnimOpenNotes: UE.WidgetAnimation;
            Background: UE.NodeToCode.UI.Components.Base.N2C_EUW_Border.N2C_EUW_Border_C;
            CodeEditor: UE.NodeToCode.UI.Components.N2C_EUW_CodeEditor.N2C_EUW_CodeEditor_C;
            ImplementationNotes: UE.NodeToCode.UI.Components.N2C_EUW_ImplementationNotes.N2C_EUW_ImplementationNotes_C;
            NavBar: UE.NodeToCode.UI.Components.N2C_EUW_NavBar.N2C_EUW_NavBar_C;
            Notification: UE.NodeToCode.UI.Components.Base.N2C_EUW_Button.N2C_EUW_Button_C;
            StatusOverlay: UE.NodeToCode.UI.Components.N2C_EUW_StatusOverlay.N2C_EUW_StatusOverlay_C;
            StyleSettings: UE.NodeToCode.UI.Components.N2C_EUW_Styling.N2C_EUW_Styling_C;
            TranslatedGraphsBrowser: UE.NodeToCode.UI.Components.N2C_EUW_TranslatedGraphsBrowser.N2C_EUW_TranslatedGraphsBrowser_C;
            LastSystemStatus: UE.EN2CSystemStatus;
            CheckForStatusChange_Timer: UE.TimerHandle;
            IsNotesOpen: boolean;
            IsTranslationsOpen: boolean;
            IsStyleSettingsOpen: boolean;
            IsDeclarationOpen: boolean;
            BndEvt__NodeToCodeUI_CodeEditor_K2Node_ComponentBoundEvent_12_OnCodeCopiedToClipboard__DelegateSignature(Text: string) : void;
            BndEvt__NodeToCodeUI_ImplementationNotes_K2Node_ComponentBoundEvent_11_OnNotesCopiedToClipboard__DelegateSignature(Text: string) : void;
            BndEvt__NodeToCodeUI_ImplementationNotes_K2Node_ComponentBoundEvent_4_OnNotesWindowCloseButtonClicked__DelegateSignature() : void;
            BndEvt__NodeToCodeUI_NavBar_K2Node_ComponentBoundEvent_0_OnGraphTranslationTabClicked__DelegateSignature(Code: string, IsDeclaration: boolean) : void;
            BndEvt__NodeToCodeUI_NavBar_K2Node_ComponentBoundEvent_1_OnStylingClicked__DelegateSignature() : void;
            BndEvt__NodeToCodeUI_NavBar_K2Node_ComponentBoundEvent_2_OnTranslationsClicked__DelegateSignature() : void;
            BndEvt__NodeToCodeUI_NavBar_K2Node_ComponentBoundEvent_3_OnTranslationNotesClicked__DelegateSignature(TranslationNotes: string) : void;
            BndEvt__NodeToCodeUI_NavBar_K2Node_ComponentBoundEvent_6_OnAssignedEmptyNotes__DelegateSignature() : void;
            BndEvt__NodeToCodeUI_NavBar_K2Node_ComponentBoundEvent_7_OnTranslationNotesUpdated__DelegateSignature(NewNotes: string) : void;
            BndEvt__NodeToCodeUI_StyleSettings_K2Node_ComponentBoundEvent_8_OnThemeChanged__DelegateSignature(NewTheme: string) : void;
            BndEvt__NodeToCodeUI_StyleSettings_K2Node_ComponentBoundEvent_9_OnCodeEditorRefRequested__DelegateSignature() : void;
            BndEvt__NodeToCodeUI_Window_TranslatedGraphs_K2Node_ComponentBoundEvent_5_OnGraphTranslationClicked__DelegateSignature(GraphTranslation: UE.N2CGraphTranslation) : void;
            CheckForStatusChange() : void;
            CloseImplementationNotes() : void;
            CloseStyleSettings() : void;
             ...
             */
            Construct() : void;
            ExecuteUbergraph_NodeToCodeUI(EntryPoint: number) : void;
            InitializeLLMBindings() : void;
            InitializeStatusOverlay() : void;
            InitializeStyleSettings() : void;
            OnTranslationRequestSent() : void;
            OnTranslationResponseRecieved(Response: UE.N2CTranslationResponse, bSuccess: boolean) : void;
            OpenImplementationNotes(Notes: string) : void;
             ...
             */
            PreConstruct(IsDesignTime: boolean) : void;
            PropogateThemeToComponents(Theme: string) : void;
            ShowNotification() : void;
            StartCheckingForStatusChange() : void;
            StopCheckingForStatusChange() : void;
            ToggleStyleSettingsMenu() : void;
            ToggleTranslationNotes(Notes: string) : void;
            ToggleTranslationsModal() : void;
            ToggleTranslationState() : void;
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): NodeToCodeUI_C;
            static Load(InName: string): NodeToCodeUI_C;
        
            __tid_NodeToCodeUI_C_0__: boolean;
        }
...
// __TYPE_DECL_END
// __TYPE_DECL_START: 87AF387C48FE67538DCB7AB5D999B78C
    namespace Game.StarterContent.CaseTestWidget {
        class CaseTestWidget_C extends UE.UserWidget {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            UberGraphFrame: UE.PointerToUberGraphFrame;
            Button: UE.Button;
            Button_close: UE.Button;
            Overlay: UE.Overlay;
            TextBox: UE.MultiLineEditableTextBox;
            BndEvt__CaseTestWidget_Button_close_K2Node_ComponentBoundEvent_5_OnButtonClickedEvent__DelegateSignature() : void;
            ExecuteUbergraph_CaseTestWidget(EntryPoint: number) : void;
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): CaseTestWidget_C;
            static Load(InName: string): CaseTestWidget_C;
        
            __tid_CaseTestWidget_C_0__: boolean;
        }
...
// __TYPE_DECL_START: ASSOCIATION
    namespace Engine.PythonTypes {
        class LatentActionCallback__PythonCallable extends UE.PythonCallableForDelegate {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): LatentActionCallback__PythonCallable;
            static Load(InName: string): LatentActionCallback__PythonCallable;
        
            __tid_LatentActionCallback__PythonCallable_0__: boolean;
        }
...
// __TYPE_DECL_START: ASSOCIATION
    namespace Engine.PythonTypes {
        class LoadedCallback__PythonCallable extends UE.PythonCallableForDelegate {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): LoadedCallback__PythonCallable;
            static Load(InName: string): LoadedCallback__PythonCallable;
        
            __tid_LoadedCallback__PythonCallable_0__: boolean;
        }
...
// __TYPE_DECL_START: ASSOCIATION
    namespace Engine.PythonTypes {
        class MainObject_Callback__PythonCallable extends UE.PythonCallableForDelegate {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): MainObject_Callback__PythonCallable;
            static Load(InName: string): MainObject_Callback__PythonCallable;
        
            __tid_MainObject_Callback__PythonCallable_0__: boolean;
        }
...
// __TYPE_DECL_START: ASSOCIATION
    namespace Engine.PythonTypes {
        class N2CCodeEditorWidget_OnCursorMovedEvent__PythonCallable extends UE.PythonCallableForDelegate {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): N2CCodeEditorWidget_OnCursorMovedEvent__PythonCallable;
            static Load(InName: string): N2CCodeEditorWidget_OnCursorMovedEvent__PythonCallable;
        
            __tid_N2CCodeEditorWidget_OnCursorMovedEvent__PythonCallable_0__: boolean;
        }
...
// __TYPE_DECL_START: ASSOCIATION
    namespace Engine.PythonTypes {
        class N2CCodeEditorWidget_OnSelectionChangedEvent__PythonCallable extends UE.PythonCallableForDelegate {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): N2CCodeEditorWidget_OnSelectionChangedEvent__PythonCallable;
            static Load(InName: string): N2CCodeEditorWidget_OnSelectionChangedEvent__PythonCallable;
        
            __tid_N2CCodeEditorWidget_OnSelectionChangedEvent__PythonCallable_0__: boolean;
        }
...
// __TYPE_DECL_START: ASSOCIATION
    namespace Engine.PythonTypes {
        class N2CCodeEditorWidget_OnTextChangedEvent__PythonCallable extends UE.PythonCallableForDelegate {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): N2CCodeEditorWidget_OnTextChangedEvent__PythonCallable;
            static Load(InName: string): N2CCodeEditorWidget_OnTextChangedEvent__PythonCallable;
        
            __tid_N2CCodeEditorWidget_OnTextChangedEvent__PythonCallable_0__: boolean;
        }
...
// __TYPE_DECL_START: ASSOCIATION
    namespace Engine.PythonTypes {
        class Notify__PythonCallable extends UE.PythonCallableForDelegate {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): Notify__PythonCallable;
            static Load(InName: string): Notify__PythonCallable;
        
            __tid_Notify__PythonCallable_0__: boolean;
        }
...
// __TYPE_DECL_START: ASSOCIATION
    namespace Engine.PythonTypes {
        class NotifyWithInt__PythonCallable extends UE.PythonCallableForDelegate {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): NotifyWithInt__PythonCallable;
            static Load(InName: string): NotifyWithInt__PythonCallable;
        
            __tid_NotifyWithInt__PythonCallable_0__: boolean;
        }
...
// __TYPE_DECL_START: ASSOCIATION
    namespace Engine.PythonTypes {
        class NotifyWithNothing__PythonCallable extends UE.PythonCallableForDelegate {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): NotifyWithNothing__PythonCallable;
            static Load(InName: string): NotifyWithNothing__PythonCallable;
        
            __tid_NotifyWithNothing__PythonCallable_0__: boolean;
        }
...
// __TYPE_DECL_START: ASSOCIATION
    namespace Engine.PythonTypes {
        class NotifyWithRefString__PythonCallable extends UE.PythonCallableForDelegate {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): NotifyWithRefString__PythonCallable;
            static Load(InName: string): NotifyWithRefString__PythonCallable;
        
            __tid_NotifyWithRefString__PythonCallable_0__: boolean;
        }
...
// __TYPE_DECL_START: ASSOCIATION
    namespace Engine.PythonTypes {
        class NotifyWithString__PythonCallable extends UE.PythonCallableForDelegate {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): NotifyWithString__PythonCallable;
            static Load(InName: string): NotifyWithString__PythonCallable;
        
            __tid_NotifyWithString__PythonCallable_0__: boolean;
        }
...
// __TYPE_DECL_START: ASSOCIATION
    namespace Engine.PythonTypes {
        class NotifyWithStringRet__PythonCallable extends UE.PythonCallableForDelegate {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): NotifyWithStringRet__PythonCallable;
            static Load(InName: string): NotifyWithStringRet__PythonCallable;
        
            __tid_NotifyWithStringRet__PythonCallable_0__: boolean;
        }
...
// __TYPE_DECL_START: ASSOCIATION
    namespace Engine.PythonTypes {
        class OnTranslationRequestSent__PythonCallable extends UE.PythonCallableForDelegate {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): OnTranslationRequestSent__PythonCallable;
            static Load(InName: string): OnTranslationRequestSent__PythonCallable;
        
            __tid_OnTranslationRequestSent__PythonCallable_0__: boolean;
        }
...
// __TYPE_DECL_START: ASSOCIATION
    namespace Engine.PythonTypes {
        class OnTranslationResponseReceived__PythonCallable extends UE.PythonCallableForDelegate {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): OnTranslationResponseReceived__PythonCallable;
            static Load(InName: string): OnTranslationResponseReceived__PythonCallable;
        
            __tid_OnTranslationResponseReceived__PythonCallable_0__: boolean;
        }
